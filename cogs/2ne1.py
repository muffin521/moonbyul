...
class twoneone(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.bot.parkbom_gif = ["https://cdn.discordapp.com/attachments/703871901411573850/795766103766466570/image1.gif",
            ...
            "https://cdn.discordapp.com/attachments/302268299729829888/811091266426241064/YiQG.gif"]
    ...
    async def twoneone(self, ctx, *, arg="2ne1"):
        ...
        await channel.send(f"`{current_time} | USED COMMAND [2ne1 {arg}] | USER: {ctx.author.name} [{(ctx.author.id)} | GUILD: {ctx.guild.name} [{ctx.guild.id}]]`" )
        if arg == "cl":
