...
class EnhypenPings(commands.Cog):
    ...
    def __init__(self, client):
        ...
        #6
        self.sunoo_gif = ["https://tenor.com/view/sunoo-enhypen-enhypen-sunoo-chamber5-halloween-fruit-gif-18991845",
        ...
        #5
        self.sunghoon_gif = ["https://tenor.com/view/sunghoon-parksunghoon-sunghoon-iland-gif-18497043",
        ...
        #5
        self.jake_gif = ["https://tenor.com/view/shim-jake-jake-enhypen-jake-gif-18619802",
        ...
        #5
        self.jungwon_gif = ["https://tenor.com/view/yang-jungwon-jungwon-iland-jungwon-iland-gif-18187930",
        ...
        #5
        self.jay_gif = ["https://tenor.com/view/jay-jay-enhypen-enhypen-jay-iland-mnet-iland-gif-18611729",
        ...
        #5
        self.niki_gif = ["https://tenor.com/view/niki-niki-enhypen-niki-woah-woah-niki-dance-gif-19028474",
    ...
    async def sunoo(self, ctx):
        if ctx.guild.id == luminary:
            if ctx.channel.id == kbotcom:
                ...
                await ctx.send(random.choice(self.sunoo_gif))
    ...
    async def sunghoon(self, ctx):
        if ctx.guild.id == luminary:
            if ctx.channel.id == kbotcom:
                ...
                await ctx.send(random.choice(self.sunghoon_gif))
                await ctx.message.delete()
            else:
                await ctx.send(content=f'Wrong channel <@!{ctx.author.id}>! Go to <#764610881513324574>', delete_after=2)
                await ctx.message.delete()
    ...
    async def jake(self, ctx):
        if ctx.guild.id == luminary:
            if ctx.channel.id == kbotcom:
                ...
                await ctx.send(random.choice(self.jake_gif))
                await ctx.message.delete()
            else:
                await ctx.send(content=f'Wrong channel <@!{ctx.author.id}>! Go to <#764610881513324574>', delete_after=2)
                await ctx.message.delete()
    ...
    async def jungwon(self, ctx):
        if ctx.guild.id == luminary:
            if ctx.channel.id == kbotcom:
                ...
                await ctx.send(random.choice(self.jungwon_gif))
                await ctx.message.delete()
            else:
                await ctx.send(content=f'Wrong channel <@!{ctx.author.id}>! Go to <#764610881513324574>', delete_after=2)
                await ctx.message.delete()
    ...
    async def jay(self, ctx):
        if ctx.guild.id == luminary:
            if ctx.channel.id == kbotcom:
                ...
                await ctx.send(random.choice(self.jay_gif))
                await ctx.message.delete()
            else:
                await ctx.send(content=f'Wrong channel <@!{ctx.author.id}>! Go to <#764610881513324574>', delete_after=2)
                await ctx.message.delete()
    ...
    async def niki(self, ctx):
        if ctx.guild.id == luminary:
            if ctx.channel.id == kbotcom:
                ...
                await ctx.send(random.choice(self.niki_gif))
                await ctx.message.delete()
            else:
                await ctx.send(content=f'Wrong channel <@!{ctx.author.id}>! Go to <#764610881513324574>', delete_after=2)
                await ctx.message.delete()
